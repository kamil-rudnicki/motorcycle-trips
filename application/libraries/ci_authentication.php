...
class ci_authentication
{
	...
	public function do_login()
	{
        ...
        //set login time
        $this->_ci->user_model->update($user_row[config_item('user_id_field')], array('login_time' => date('Y-m-d H:i:s')));
        $this->_ci->user_model->increase_login_number($user_row[config_item('user_id_field')]);
